...
# METHOD 1: Basic Similarity Search (Returns the top k most similar documents)
...
# METHOD 2: Similarity with Score Threshold (Only returns documents above a certain similarity score)
...
# # METHOD 3: Maximum Marginal Relevance (MMR) (Balances relevance and diversity - avoids redundant results)
